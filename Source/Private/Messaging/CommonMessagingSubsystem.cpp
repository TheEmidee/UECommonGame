...
void UCommonMessagingSubsystem::ShowConfirmation(UCommonGameDialogDescriptor * DialogDescriptor, TSubclassOf< UCommonGameDialog > CustomDialogWidget, FCommonMessagingResultDelegate ResultCallback)
{
