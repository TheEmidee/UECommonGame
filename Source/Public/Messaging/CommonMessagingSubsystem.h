...
public:
	...
	virtual void ShowConfirmation(UCommonGameDialogDescriptor* DialogDescriptor, TSubclassOf< UCommonGameDialog > CustomDialogWidget, FCommonMessagingResultDelegate ResultCallback = FCommonMessagingResultDelegate());
};
